...
import fr.csmb.competition.Helper.CompetitionHelper;
...
//        }
        ...
        ClassementHelper.computeClassementCombatClub(competitionBean.getClubs());
...
//        sortableList.sort(new Comparator<ClubBean>() {
...
//        sortableList.sort(new ComparatorClubTotalTechnique());
//        int i = 0;
//        ClubBean previousClub = null;
//        for (ClubBean club : sortableList) {
//            if (previousClub != null) {
...
//        sortableList.sort(new ComparatorClubTotalCombat());
//        int i = 0;
//        ClubBean previousClub = null;
//        for (ClubBean club : sortableList) {
//            if (previousClub != null) {
