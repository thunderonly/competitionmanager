...
public class GridComponentTechnical extends GridComponent {
    ...
    public List<ParticipantBean> getResultatsList() {
        ...
        resultats.sort(new Comparator<ParticipantBean>() {
    ...
    private void computeClassementAuto() {
        ClassementHelper.computeClassementAutoEpreuveTechnique(data);
        for (ParticipantBean participantBean : data) {
            this.participantClassementFinalListener.fireUpdateClassementFinal(participantBean);
        }
//        SortedList<ParticipantBean> parts = new SortedList<ParticipantBean>(data);
//        parts.sort(new ComparatorEpreuveParticipantTechnique());
//        int i = 0;
